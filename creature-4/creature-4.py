...
class Tiny:
    ...
    def move(self):
        ...
        # tiny moves in random curved direction upon spawn
        self.pos += self.vel
        self.vel += py5.Py5Vector(py5.random(-0.2, 0.2), py5.random(-0.2, 0.2))

        # Tiny's trail is lower opacity as it moves
        self.opacity = max(5, self.opacity - 4)
